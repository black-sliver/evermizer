...
const static struct alchemy_data alchemy_locations[] = {
    ...
    {"Escape",          0x0b, true,  escape_locations,         {0xb08042 +4 -0x800000,LOC_END}},
    ...
    {"Revealer",        0x1c, true,  revealer_locations,       {0x96db4b +4 -0x800000,LOC_END}},
...
static const check_tree_item blank_check_tree[] = {
    ...
    {0, CHECK_ALCHEMY,FIRE_POWER_IDX,      1, REQ2(P_WEAPON,P_QUEENS_KEY),                   NOTHING_PROVIDED},
    ...
    {0, CHECK_BOSS,MEGATAUR_IDX,      0, REQ2(P_BRONZE_SPEAR,P_REVEALER),         PVD1(P_PYRAMID_OR_RUINS)},
